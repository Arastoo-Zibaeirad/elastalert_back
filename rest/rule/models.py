...
class CustomRuleManager(models.Manager):    
    def create(self, **kwargs):
        ...
        with open(r'testyaml.yaml', 'w') as file:
...
#         rule = Rule.objects.create(name=kwargs["strategy_name"], queries=)
...
class Strategy(models.Model):
    rule = models.ManyToManyField(Rule, related_name='strategy')
